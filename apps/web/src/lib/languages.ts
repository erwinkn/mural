...
const THEME_TITLES: Record<string, Record<string, string>> = {
  ...
  ru: {
    coffee: 'Чай или кофе?', weekend: 'Выходные', walk: 'Небольшая прогулка', dinner: 'Планы на ужин',
    introductions: 'Приятно познакомиться', groceries: 'На рынке', travel: 'В дорогу',
    home: 'Свой угол', friends: 'Новые друзья', work: 'Утро понедельника',
    weather: 'Опять дождь?', cabin: 'На даче', music: 'На повторе',
    film: 'Ещё одну серию', books: 'Между строк', design: 'Красивые вещи',
    technology: 'Что дальше?', travelstories: 'Где-то далеко', restaurant: 'Столик на двоих',
    neighbours: 'Соседи', traditions: 'Разговор на кухне', opinions: 'А ты как думаешь?',
    future: 'Через год', today: 'Мир сегодня',
  },
}
...
const russian: LanguageModule = {
  ...
  themeOverrides: {
    coffee: { id: 'coffee', title: 'Чай или кофе?', subtitle: 'Something warm, please', symbol: 'cup.and.saucer', category: 'Everyday', situation: "Meet at a neighbourhood café in a Russian-speaking city. Order tea or coffee, perhaps with something sweet, and chat about the learner's day. Use вы with staff and ты with a friend.", colorIndex: 0 },
    groceries: { id: 'groceries', title: 'На рынке', subtitle: 'A little of everything', symbol: 'basket', category: 'Everyday', situation: 'Shop at a market in a Russian-speaking city. Practise quantities, prices and polite requests, including the genitive after numbers, and accept regional names for foods.', colorIndex: 2 },
    travel: { id: 'travel', title: 'В дорогу', subtitle: 'A ticket to somewhere', symbol: 'tram', category: 'Everyday', situation: 'Plan a long-distance train trip in Russia. Discuss routes, carriages and tickets without inventing current schedules, prices or travel rules.', colorIndex: 1 },
    cabin: { id: 'cabin', title: 'На даче', subtitle: 'A quieter kind of day', symbol: 'tree', category: 'Local life', situation: 'Spend an imagined weekend at a dacha outside the city. Talk about the garden, cooking, the banya and slow summer days.', colorIndex: 2 },
    traditions: { id: 'traditions', title: 'Разговор на кухне', subtitle: 'Stay a little longer', symbol: 'fork.knife', category: 'Local life', situation: "Talk at an imagined kitchen table over tea about routines, holidays and everyday customs. Compare the learner's experiences without treating Russian-speaking cultures as uniform.", colorIndex: 2 },
  },
}

export const DEFAULT_LANGUAGE_ID = 'en'
export const ALL_LANGUAGES: LanguageModule[] = [norwegian, spanish, english, french, german, italian, portuguese, mandarin, russian]
